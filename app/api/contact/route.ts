...
<head>
  <style>
    ...
    .message-box { background: white; padding: 15px; border-left: 4px solid #111; margin-top: 10px; white-space: pre-wrap; }
...
<body>
  <div class="container">
    <div class="header">
      <h2 style="margin: 0;">New Portfolio Contact Form Submission</h2>
    </div>
    ...
    <div class="content">
      ...
      ${company ? `<div class="field"><span class="label">Company/Organization:</span> ${company}</div>` : ""}
...
`;
    ...
    try {
      ...
      return NextResponse.json(
        { error: "Failed to send email. Please check your API key." },
        { status: 500 }
      );
    }
  } catch (error) {
